...
{
    public class CityPeopleScript : MonoBehaviour
    {
        [SerializeField]
        ...
        private void Awake()
        {
            ...
            foreach (Renderer r in AllRenderers)
            {
                ...
                if (matName[0..len] == CityPeopleScript.people_pal_prefix)
                {
        ...
        public void SetPalette(Material mat)
        {
            if (mat != null)
            {
                if (mat.name[0..people_pal_prefix.Length] == CityPeopleScript.people_pal_prefix)
                {
